...
//@interface MineTimeObject : NSObject
//@end

@interface MineTimeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MineTimeObject class]])
		{
			for (NSString *key in [[(MineTimeObject*)o modules] allKeys])
			{
