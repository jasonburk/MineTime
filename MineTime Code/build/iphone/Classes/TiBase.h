...
// in simulator we redefine to format for MineTime Developer console
...
{\
	NSString * exceptionName = [@"org.minetime." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.minetime";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMineTimeNativeItemNone = -1, 
	UIMineTimeNativeItemSpinner = -2,
	UIMineTimeNativeItemProgressBar = -3,
	
	UIMineTimeNativeItemSlider = -4,
	UIMineTimeNativeItemSwitch = -5,
	UIMineTimeNativeItemMultiButton = -6,
	UIMineTimeNativeItemSegmented = -7,
	
	UIMineTimeNativeItemTextView = -8,
	UIMineTimeNativeItemTextField = -9,
	UIMineTimeNativeItemSearchBar = -10,
	
	UIMineTimeNativeItemPicker = -11,
	UIMineTimeNativeItemDatePicker = -12,
	
	UIMineTimeNativeItemInfoLight = -13,
	UIMineTimeNativeItemInfoDark = -14,
	
	UIMineTimeNativeItemDisclosure = -15,
	
	UIMineTimeNativeItemContactAdd = -16
};
